...
namespace AHZ_Online_Library
{
    public partial class WebForm4 : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("select count(*) from Admin_Login  where Email= '" + TextBox1.Text + "'", con);
                ...
                {
                    con.Open();
                    SqlCommand passcmd = new SqlCommand(" select Password_ from Admin_Login where Email= '" + TextBox1.Text + "'", con);
